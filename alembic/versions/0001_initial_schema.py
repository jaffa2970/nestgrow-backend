...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("ts", sa.DateTime(fsp=3), nullable=False, server_default=sa.text("NOW(3)")),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), autoincrement=True, primary_key=True),
        sa.Column("zona_id", sa.Integer(), sa.ForeignKey("zone.id"), nullable=False),
        sa.Column("ts_inizio", sa.DateTime(fsp=3), nullable=False),
        sa.Column("ts_fine", sa.DateTime(fsp=3), nullable=True),
